...
for feature_group in feature_groups_single:
    ...
    X1 = pd.read_csv(f"../../Features/pHopt/{feature_group}/train.csv", header=None).values
    X = pd.read_csv(f"../../Features/pHopt/{feature_group}/test.csv", header=None).values
    length = X.shape[0]
...
X = pd.read_csv(f"../../Features/pHopt/ankh/embeddings_test.csv", header=None).values
...
print(X.shape)
y_test = np.load(f"../../Features/pHopt_test_labels.npy")
